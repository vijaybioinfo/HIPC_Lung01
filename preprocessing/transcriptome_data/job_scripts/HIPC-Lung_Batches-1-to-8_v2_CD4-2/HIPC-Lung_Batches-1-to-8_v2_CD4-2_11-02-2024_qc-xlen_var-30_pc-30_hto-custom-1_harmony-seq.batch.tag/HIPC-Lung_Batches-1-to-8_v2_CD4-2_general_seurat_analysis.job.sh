#!/bin/sh
#SBATCH --job-name=HIPC-Lung_Batches-1-to-8_v2_CD4-2_SA
#SBATCH --output=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-2/HIPC-Lung_Batches-1-to-8_v2_CD4-2_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_CD4-2_general_seurat_analysis.out.txt
#SBATCH --error=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-2/HIPC-Lung_Batches-1-to-8_v2_CD4-2_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_CD4-2_general_seurat_analysis.err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo -e "Project name: HIPC-Lung_Batches-1-to-8_v2_CD4-2"
echo -e "Job output directory: /path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-2/HIPC-Lung_Batches-1-to-8_v2_CD4-2_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag"
