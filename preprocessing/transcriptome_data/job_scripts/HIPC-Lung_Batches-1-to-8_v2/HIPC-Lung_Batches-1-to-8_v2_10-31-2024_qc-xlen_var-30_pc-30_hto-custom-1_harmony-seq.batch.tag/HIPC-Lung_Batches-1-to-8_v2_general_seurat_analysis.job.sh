#!/bin/sh
#SBATCH --job-name=HIPC-Lung_Batches-1-to-8_v2_SA
#SBATCH --output=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_general_seurat_analysis.out.txt
#SBATCH --error=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_general_seurat_analysis.err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo -e "Project name: HIPC-Lung_Batches-1-to-8_v2"
echo -e "Job output directory: /path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag"
...
--ReportsPath /root/hpcscratch/vfajardo/HIPC/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag --PrjName HIPC-Lung_Batches-1-to-8_v2 --RAM 500 \
--DataFile /path/to/user/sequencing_data/11-17-2023/aggr/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8/outs/count/filtered_feature_bc_matrix --Raw10x /path/to/user/sequencing_data/11-17-2023/aggr/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8/outs/count/filtered_feature_bc_matrix --InputType matrix --FeatureID name \
