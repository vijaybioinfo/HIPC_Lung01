#!/bin/sh
#SBATCH --job-name=HIPC-Lung_Batches-1-to-8_v2_CD4-1_SA
#SBATCH --output=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-1/HIPC-Lung_Batches-1-to-8_v2_CD4-1_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_CD4-1_general_seurat_analysis.out.txt
#SBATCH --error=/path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-1/HIPC-Lung_Batches-1-to-8_v2_CD4-1_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/HIPC-Lung_Batches-1-to-8_v2_CD4-1_general_seurat_analysis.err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo -e "Project name: HIPC-Lung_Batches-1-to-8_v2_CD4-1"
echo -e "Job output directory: /path/to/user/HIPC/jobs_scripts/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-1/HIPC-Lung_Batches-1-to-8_v2_CD4-1_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag"
...
--ReportsPath /root/hpcscratch/vfajardo/HIPC/seurat_analysis//HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2_CD4-1/HIPC-Lung_Batches-1-to-8_v2_CD4-1_11-02-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag --PrjName HIPC-Lung_Batches-1-to-8_v2_CD4-1 --RAM 450 \
--DataFile /path/to/user/HIPC/seurat_analysis/HIPC-Lung/HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/seurat_objects/SeuratObjectForPrjHIPC-Lung_Batches-1-to-8_v2_WithArgs_NoPCs_30.RDS  --InputType seurat --FeatureID name --DoPreSubset TRUE --PreSubsetCriteria /path/to/user/HIPC/paper_developments/HIPC-Lung/data_for_subsetting/custom_subsets//HIPC-Lung//HIPC-Lung_Batches-1-to-8_v2/HIPC-Lung_Batches-1-to-8_v2_10-31-2024_qc-xlen_var-30_pc-30_hto-custom-1_harmony-seq.batch.tag/CD4-1/TagsSubsetCriteria.csv \
