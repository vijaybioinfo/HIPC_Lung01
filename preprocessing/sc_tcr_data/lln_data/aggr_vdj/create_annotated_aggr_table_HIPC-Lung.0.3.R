...
input.run.dates <- c(
  ...
  '06-07-2024', '07-08-2024'
)
output.run.date <- '12-15-2024'
aggr.id <- arguments[1]
...
# Custom modifications. Not required any longer.
# sample.ids.info[
#   sample.ids.info$sample.id=='AqEhHIPCLN01_24_TCR',
#   'sample.id'
# ] <- 'AqEh_HIPC_LN01_24_TCR'
