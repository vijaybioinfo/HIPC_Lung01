#!/bin/sh
#SBATCH --job-name=BOOST_Round-4_CD4_SA
#SBATCH --output=/mnt/hpcscratch/vfajardo/BOOST/jobs_scripts/seurat_analysis//BOOST_CD4/BOOST_Round-4_CD4/BOOST_Round-4_CD4_08-09-2023_qc-std_var-30_pc-30_hto-all_cohort-all_harmony-seq.batch.tag/BOOST_Round-4_CD4_general_seurat_analysis.out.txt
#SBATCH --error=/mnt/hpcscratch/vfajardo/BOOST/jobs_scripts/seurat_analysis//BOOST_CD4/BOOST_Round-4_CD4/BOOST_Round-4_CD4_08-09-2023_qc-std_var-30_pc-30_hto-all_cohort-all_harmony-seq.batch.tag/BOOST_Round-4_CD4_general_seurat_analysis.err.txt
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo -e "Project name: BOOST_Round-4_CD4"
echo -e "Job output directory: /mnt/hpcscratch/vfajardo/BOOST/jobs_scripts/seurat_analysis//BOOST_CD4/BOOST_Round-4_CD4/BOOST_Round-4_CD4_08-09-2023_qc-std_var-30_pc-30_hto-all_cohort-all_harmony-seq.batch.tag"
